...
const ArtikelPage = () => {
    ...
    const filteredArtikel = dataArtikelfull.filter((item) => {
 ...
 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    ...
                    <div className="flex justify-center mb-6 mt-6">
                        <input
                            type="text"
                            placeholder="Cari artikel atau informasi wisata..."
                            value={search}
    ...
    focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      ${selectedCategory === cat
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {filteredArtikel.slice(0, visibleCount).map((item, index) => (
                            <div
                                key={item.id}
                    ...
                    {visibleCount < filteredArtikel.length && (
